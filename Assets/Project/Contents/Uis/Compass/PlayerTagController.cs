...
public class PlayerTagController :
    BaseInterfaceConsumer<SetClientInputProviderEvent, RequestClientInputProviderEvent, IClientInputProvider>, ITickable
{
    ...
    protected override IClientInputProvider GetTargetFromEvent(SetClientInputProviderEvent evt)
    {
        return evt.Provider;    
    }
}