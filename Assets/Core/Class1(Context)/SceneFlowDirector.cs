...
public sealed class SceneFlowDirector : BaseEventListener_Automatic
{
    ...
    /// </summary>
    public static void RegisterCurrentScene(Scene currentScene)
    {
        SceneFlowDirector.currentScene = currentScene;
        SceneManager.SetActiveScene(currentScene);
        Debug.Log($"[SceneFlowDirector] 현재 콘텐츠 씬 등록 완료 (by SceneContext): {SceneFlowDirector.currentScene.name}");
    }
